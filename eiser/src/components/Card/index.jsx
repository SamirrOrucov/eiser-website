    ...
    <div id='card_container'>
        <div className="container">
            ...
            <div className="product_info">
                ...
                <p className="price"><b>${price}</b></p> <span style={{fontWeight:"lighter",textDecoration:"line-through"}}>$100.00</span>
                <div className="hidden_links">
                    <div className="eye icn">
                        <Link to={"/detail:id"}><i className="fa-regular fa-eye"></i></Link>
                    </div>
                    <div className="heart icn">
                        <Link to={"/wishlist"}><i className="fa-regular fa-heart"></i></Link>
                    </div><div className="cart icn"  onClick={()=>{addBasket(x)}}>
